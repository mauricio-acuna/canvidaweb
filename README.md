...
Puedes abrir `index.html` directamente en el navegador. Para probarla mediante un servidor local:
...
Este repositorio contiene únicamente los archivos necesarios para la web pública. No deben añadirse documentos internos, credenciales, datos de clientes ni material privado.
